...
def LDFcheck(TargetShower, SimulatedShower):
    ...
    wvxvxb_scaled = w_scaled[(l<nstarshape) & ((l)%4==0)]
    wvxvxb_scaled[m%2==0] = -wvxvxb_scaled[m%2==0]
    wvxvxb_sim = w_sim[(l<nstarshape) & ((l)%4==0)]
...
# =============================================================================
    ...
    x2, y2, z2  = positions[:,0], positions[:,1], positions[:,2]
    x2, y2, z2 = x2 - core[0], y2 - core[1], z2 - core[2]
